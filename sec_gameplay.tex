...
\section{Gameplay}\label{sec:Gameplay}
	...
	\subsection{Winning The Game/Redemption}\label{ssec:Winning}
        \begin{enumerate}[label=(\roman*), ref=\roman*]
            ...
            \item \label{itm:Winning,shutout} A shutout occurs when a player/team sinks there a ball in their opponent's final cup while no cups are removed from the other rack.
